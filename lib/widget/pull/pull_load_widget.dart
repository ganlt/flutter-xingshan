...
///通用下上刷新控件
class XSPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  @override
  _XSPullLoadWidgetState createState() => _XSPullLoadWidgetState(this.control,
      this.itemBuilder, this.onRefresh, this.onLoadMore, this.refreshKey);
}

class _XSPullLoadWidgetState extends State<XSPullLoadWidget> {
  final IndexedWidgetBuilder itemBuilder;
  ...
  _XSPullLoadWidgetState(this.control, this.itemBuilder, this.onRefresh,
