...
class XSPayPage extends StatefulWidget {
  XSPayPage({Key key, this.title}): super(key: key);

  final String title;

  @override
  _XSPayPageState createState() => _XSPayPageState();
}
...
class _XSPayPageState extends State<XSPayPage> {
  @override
          ...
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Divider(color: XSColors.dividerColor),
                Container(
                  padding: EdgeInsets.all(20.0),
                  child: Column(
